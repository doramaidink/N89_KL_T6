    ...
    <div className="nhomchat">
      ...
      <div className="info-nhomchat">
        ...
        <div className="box-nhomchat">
          <p className="title-box-nhomchat">AN TOÀN & ĐIỂM DANH</p>
          <div className="check-nhomchat">
            <button className="btn-checkin-nhomchat">CHECK IN</button>
            <button className="btn-checkout-nhomchat">CHECK OUT</button>
          </div>
        </div>
